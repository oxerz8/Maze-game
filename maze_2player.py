...
class Player:
    '''
    A player for MazeGame
    '''

    def __init__(self,name,x,y):
        '''
        (Player, string, int, int) -> None
        Construct a new player with the given name x and y position
        coordinates. MazeGame should also place a "gold" at
        a randomly chosen coordinate on the far edge of the grid.
        '''
        self.name=name
        self.x=x
...
class ComputerPlayer(Player):
    '''
    A Computer player for MazeGame.
    '''
    
    def get_direction(self):
        '''(Player)->int
        Randomly chooses a character from
        a list of characters and returns it.
        '''
        d=['N','S','E','W']
